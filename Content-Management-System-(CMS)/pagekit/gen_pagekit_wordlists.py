...
if __name__ == '__main__':
    ...
    versions = get_releases_from_github("pagekit", "pagekit")
    ...
    for version in versions.keys():
        ...
        if not os.path.exists('./versions/%s/' % (str_version)):
            ...
            print('[>] Ignoring pagekit version %s (local wordlists exists)' % str_version)

        if generate:
            print('[>] Extracting wordlists for pagekit version %s' % str_version)

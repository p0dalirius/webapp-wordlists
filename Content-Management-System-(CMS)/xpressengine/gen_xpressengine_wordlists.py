...
if __name__ == '__main__':
    ...
    versions = get_releases_from_github("xpressengine", "xpressengine")
    ...
    for version in versions.keys():
        ...
        if not os.path.exists('./versions/%s/' % (str_version)):
            ...
            print('[>] Ignoring xpressengine version %s (local wordlists exists)' % str_version)

        if generate:
            print('[>] Extracting wordlists for xpressengine version %s' % str_version)
